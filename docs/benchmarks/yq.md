...
| Size       | succinctly   | yq           | Speedup       | succ Mem | yq Mem  | Mem Ratio |
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    4.9 ms    |    8.1 ms    | **1.6x**      |    7 MB  |   14 MB | **0.54x** |
| **10KB**   |    5.2 ms    |    8.6 ms    | **1.7x**      |    7 MB  |   14 MB | **0.51x** |
| **100KB**  |    6.2 ms    |   19.5 ms    | **3.2x**      |    8 MB  |   23 MB | **0.34x** |
| **1MB**    |   17.7 ms    |  114.4 ms    | **6.5x**      |   10 MB  |   79 MB | **0.12x** |
| **10MB**   |  122.0 ms    |    1.02 s    | **8.3x**      |   31 MB  |  683 MB | **0.05x** |
| **100MB**  |    1.10 s    |    9.80 s    | **8.9x**      |  239 MB  |    6 GB | **0.04x** |
...
| Size       | succinctly   | yq           | Speedup       | succ Mem | yq Mem  | Mem Ratio |
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    5.1 ms    |    8.0 ms    | **1.6x**      |    7 MB  |   14 MB | **0.54x** |
| **10KB**   |    5.3 ms    |    8.0 ms    | **1.5x**      |    7 MB  |   13 MB | **0.55x** |
| **100KB**  |    6.0 ms    |    8.3 ms    | **1.4x**      |    7 MB  |   13 MB | **0.55x** |
| **1MB**    |    5.0 ms    |    7.8 ms    | **1.6x**      |    7 MB  |   13 MB | **0.55x** |
| **10MB**   |    5.3 ms    |    8.0 ms    | **1.5x**      |    7 MB  |   13 MB | **0.55x** |
| **100MB**  |    5.3 ms    |    8.0 ms    | **1.5x**      |    7 MB  |   14 MB | **0.54x** |
...
| **10KB**   |    4.9 ms    |    8.9 ms    | **1.8x**      |    7 MB  |   14 MB | **0.52x** |
| **100KB**  |    6.5 ms    |   19.5 ms    | **3.0x**      |    8 MB  |   24 MB | **0.33x** |
| **1MB**    |   16.2 ms    |  114.8 ms    | **7.1x**      |   10 MB  |   89 MB | **0.11x** |
| **10MB**   |  112.8 ms    |  987.7 ms    | **8.8x**      |   30 MB  |  652 MB | **0.05x** |
| **100MB**  |    1.01 s    |    9.40 s    | **9.3x**      |  228 MB  |    7 GB | **0.03x** |
...
| Size       | succinctly   | yq           | Speedup       | succ Mem | yq Mem  | Mem Ratio |
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    5.4 ms    |    8.4 ms    | **1.6x**      |    7 MB  |   13 MB | **0.54x** |
| **10KB**   |    5.7 ms    |    9.1 ms    | **1.6x**      |    7 MB  |   14 MB | **0.52x** |
| **100KB**  |    6.6 ms    |   20.9 ms    | **3.2x**      |    8 MB  |   23 MB | **0.34x** |
| **1MB**    |   18.4 ms    |  123.7 ms    | **6.7x**      |   10 MB  |   98 MB | **0.10x** |
| **10MB**   |  126.6 ms    |    1.14 s    | **9.0x**      |   34 MB  |  748 MB | **0.04x** |
| **100MB**  |    1.22 s    |   11.35 s    | **9.3x**      |  275 MB  |    7 GB | **0.04x** |
...
| Size       | succinctly   | yq           | Speedup       | succ Mem | yq Mem  | Mem Ratio |
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    5.3 ms    |    8.2 ms    | **1.6x**      |    7 MB  |   14 MB | **0.54x** |
| **10KB**   |    4.8 ms    |    8.4 ms    | **1.7x**      |    7 MB  |   14 MB | **0.52x** |
| **100KB**  |    5.2 ms    |   14.7 ms    | **2.8x**      |    8 MB  |   20 MB | **0.38x** |
| **1MB**    |   12.1 ms    |   90.1 ms    | **7.5x**      |    9 MB  |   61 MB | **0.15x** |
| **10MB**   |   64.7 ms    |  781.8 ms    | **12.1x**     |   22 MB  |  436 MB | **0.05x** |
| **100MB**  |  491.4 ms    |    6.30 s    | **12.8x**     |  128 MB  |    4 GB | **0.04x** |
...
| Size       | succinctly   | yq           | Speedup       | succ Mem | yq Mem  | Mem Ratio |
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    4.8 ms    |    7.4 ms    | **1.5x**      |    7 MB  |   14 MB | **0.54x** |
| **10KB**   |    5.3 ms    |    8.7 ms    | **1.7x**      |    7 MB  |   14 MB | **0.52x** |
| **100KB**  |    6.1 ms    |   19.4 ms    | **3.2x**      |    8 MB  |   22 MB | **0.35x** |
| **1MB**    |   19.0 ms    |  116.6 ms    | **6.1x**      |   10 MB  |   82 MB | **0.12x** |
| **10MB**   |  132.6 ms    |    1.00 s    | **7.5x**      |   30 MB  |  592 MB | **0.05x** |
| **100MB**  |    1.20 s    |    9.37 s    | **7.8x**      |  247 MB  |    5 GB | **0.04x** |
...
| Size       | succinctly   | yq           | Speedup       | succ Mem | yq Mem  | Mem Ratio |
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    4.7 ms    |    7.4 ms    | **1.6x**      |    7 MB  |   14 MB | **0.54x** |
| **10KB**   |    4.8 ms    |    8.6 ms    | **1.8x**      |    7 MB  |   15 MB | **0.50x** |
| **100KB**  |    7.1 ms    |   23.7 ms    | **3.4x**      |    8 MB  |   24 MB | **0.32x** |
| **1MB**    |   16.7 ms    |  147.0 ms    | **8.8x**      |   10 MB  |   92 MB | **0.11x** |
| **10MB**   |  112.4 ms    |    1.31 s    | **11.6x**     |   32 MB  |  735 MB | **0.04x** |
| **100MB**  |    1.01 s    |   12.37 s    | **12.2x**     |  236 MB  |    7 GB | **0.03x** |
...
| Size       | succinctly   | yq           | Speedup       | succ Mem | yq Mem  | Mem Ratio |
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    5.6 ms    |    7.9 ms    | **1.4x**      |    7 MB  |   13 MB | **0.55x** |
| **10KB**   |    5.5 ms    |    9.1 ms    | **1.6x**      |    7 MB  |   14 MB | **0.52x** |
| **100KB**  |    6.2 ms    |   21.6 ms    | **3.5x**      |    8 MB  |   24 MB | **0.33x** |
| **1MB**    |   20.3 ms    |  130.6 ms    | **6.4x**      |   11 MB  |   96 MB | **0.11x** |
| **10MB**   |  139.8 ms    |    1.19 s    | **8.5x**      |   48 MB  |  983 MB | **0.05x** |
| **100MB**  |    1.29 s    |   11.55 s    | **9.0x**      |  406 MB  |    8 GB | **0.05x** |
...
| Size       | succinctly   | yq           | Speedup       | succ Mem | yq Mem  | Mem Ratio |
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    4.7 ms    |    7.8 ms    | **1.7x**      |    7 MB  |   14 MB | **0.54x** |
| **10KB**   |    4.7 ms    |    7.9 ms    | **1.7x**      |    7 MB  |   14 MB | **0.53x** |
| **100KB**  |    5.5 ms    |   14.5 ms    | **2.6x**      |    8 MB  |   20 MB | **0.39x** |
| **1MB**    |   13.5 ms    |   77.5 ms    | **5.7x**      |   10 MB  |   64 MB | **0.15x** |
| **10MB**   |   89.2 ms    |  671.5 ms    | **7.5x**      |   28 MB  |  425 MB | **0.07x** |
| **100MB**  |  833.9 ms    |    6.46 s    | **7.7x**      |  231 MB  |    4 GB | **0.05x** |
...
| Size       | succinctly   | yq           | Speedup       | succ Mem | yq Mem  | Mem Ratio |
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    5.0 ms    |    7.1 ms    | **1.4x**      |    7 MB  |   13 MB | **0.55x** |
| **10KB**   |    5.5 ms    |    8.5 ms    | **1.5x**      |    7 MB  |   14 MB | **0.53x** |
| **100KB**  |    6.0 ms    |   15.4 ms    | **2.6x**      |    8 MB  |   20 MB | **0.39x** |
| **1MB**    |   12.8 ms    |   76.0 ms    | **5.9x**      |   10 MB  |   61 MB | **0.16x** |
| **10MB**   |   83.6 ms    |  635.6 ms    | **7.6x**      |   28 MB  |  454 MB | **0.06x** |
| **100MB**  |  789.3 ms    |    6.19 s    | **7.8x**      |  209 MB  |    5 GB | **0.04x** |
...
|------------|--------------|--------------|---------------|----------|---------|-----------|
| **1KB**    |    4.8 ms    |    7.4 ms    | **1.5x**      |    7 MB  |   14 MB | **0.54x** |
| **10KB**   |    4.9 ms    |    8.4 ms    | **1.7x**      |    7 MB  |   14 MB | **0.52x** |
| **100KB**  |    6.1 ms    |   21.1 ms    | **3.5x**      |    8 MB  |   24 MB | **0.32x** |
| **1MB**    |   17.5 ms    |  139.0 ms    | **7.9x**      |   10 MB  |   96 MB | **0.11x** |
| **10MB**   |  135.0 ms    |    1.29 s    | **9.5x**      |   35 MB  |  868 MB | **0.04x** |
| **100MB**  |    1.28 s    |   12.81 s    | **10.0x**     |  282 MB  |    9 GB | **0.03x** |
