...
|-----------|----------|--------------|---------------|---------|----------|------------|
| **100mb** |    6.87s |    **4.23s** |      **1.6x** |    4 GB |   473 MB |      0.13x |
| **10mb**  |  717.1ms |  **390.6ms** |      **1.8x** |  367 MB |    52 MB |      0.14x |
| **1mb**   |   71.3ms |   **39.1ms** |      **1.8x** |   38 MB |    10 MB |      0.25x |
| **100kb** |    8.7ms |    **6.1ms** |      **1.4x** |    5 MB |     6 MB |      1.05x |
| **10kb**  |    3.1ms |    **2.6ms** |      **1.2x** |    2 MB |     5 MB |      2.11x |
...
| Size      | jq       | succinctly   | Speedup       | jq Mem  | succ Mem | Mem Ratio  |
|-----------|----------|--------------|---------------|---------|----------|------------|
| **100mb** |    3.75s |    **2.23s** |      **1.7x** |    1 GB |   108 MB |      0.07x |
| **10mb**  |  372.2ms |  **215.7ms** |      **1.7x** |  149 MB |    15 MB |      0.10x |
| **1mb**   |   40.0ms |   **23.6ms** |      **1.7x** |   17 MB |     6 MB |      0.39x |
| **100kb** |    6.0ms |    **4.8ms** |      **1.2x** |    3 MB |     6 MB |      1.69x |
| **10kb**  |    2.7ms |    **2.5ms** |      **1.1x** |    2 MB |     5 MB |      2.22x |
| **1kb**   |    2.6ms |    **2.4ms** |      **1.1x** |    2 MB |     5 MB |      2.22x |
...
| Size      | jq       | succinctly   | Speedup       | jq Mem  | succ Mem | Mem Ratio  |
|-----------|----------|--------------|---------------|---------|----------|------------|
| **100mb** |    2.76s |    **2.38s** |      **1.2x** |  550 MB |   134 MB |      0.24x |
| **10mb**  |  272.3ms |  **219.5ms** |      **1.2x** |   51 MB |    18 MB |      0.35x |
| **1mb**   |   28.7ms |   **23.3ms** |      **1.2x** |    7 MB |     6 MB |      0.89x |
| **100kb** |    5.4ms |    **4.2ms** |      **1.3x** |    3 MB |     5 MB |      1.75x |
| **10kb**  |    2.6ms |    **2.4ms** |      **1.1x** |    2 MB |     5 MB |      2.11x |
...
| Size      | jq       | succinctly   | Speedup       | jq Mem  | succ Mem | Mem Ratio  |
|-----------|----------|--------------|---------------|---------|----------|------------|
| **100mb** |  525.8ms |  **285.5ms** |      **1.8x** |  217 MB |    21 MB |      0.10x |
| **10mb**  |   54.7ms |   **30.2ms** |      **1.8x** |   23 MB |     6 MB |      0.27x |
| **1mb**   |    6.8ms |    **5.0ms** |      **1.4x** |    4 MB |     5 MB |      1.40x |
| **100kb** |    2.8ms |    **2.5ms** |      **1.1x** |    2 MB |     5 MB |      2.22x |
| **10kb**  |    2.5ms |      2.5ms   |          1.0x |    2 MB |     5 MB |      2.22x |
| **1kb**   |    2.5ms |    **2.4ms** |      **1.0x** |    2 MB |     5 MB |      2.22x |

## Pattern: nested

| Size      | jq       | succinctly   | Speedup       | jq Mem  | succ Mem | Mem Ratio  |
|-----------|----------|--------------|---------------|---------|----------|------------|
| **100mb** |    1.45s |  **558.6ms** |      **2.6x** |  202 MB |   227 MB |      1.12x |
| **10mb**  |  144.1ms |   **55.8ms** |      **2.6x** |   22 MB |    27 MB |      1.21x |
| **1mb**   |   16.6ms |    **7.7ms** |      **2.2x** |    4 MB |     7 MB |      1.65x |
| **100kb** |    3.8ms |    **2.8ms** |      **1.4x** |    2 MB |     5 MB |      2.10x |
| **10kb**  |    2.5ms |    **2.3ms** |      **1.1x** |    2 MB |     5 MB |      2.22x |
| **1kb**   |    2.6ms |    **2.4ms** |      **1.1x** |    2 MB |     5 MB |      2.22x |
...
| Size      | jq       | succinctly   | Speedup       | jq Mem  | succ Mem | Mem Ratio  |
|-----------|----------|--------------|---------------|---------|----------|------------|
| **100mb** |    2.72s |    **1.31s** |      **2.1x** |  855 MB |   120 MB |      0.14x |
| **10mb**  |  269.1ms |  **127.9ms** |      **2.1x** |   87 MB |    16 MB |      0.19x |
| **1mb**   |   28.7ms |   **14.5ms** |      **2.0x** |   10 MB |     6 MB |      0.58x |
| **100kb** |    4.6ms |    **3.5ms** |      **1.3x** |    2 MB |     5 MB |      2.10x |
| **10kb**  |    2.6ms |      2.8ms   |          0.9x |    2 MB |     5 MB |      2.22x |
| **1kb**   |    2.7ms |    **2.3ms** |      **1.2x** |    2 MB |     5 MB |      2.22x |

## Pattern: pathological

| Size      | jq       | succinctly   | Speedup       | jq Mem  | succ Mem | Mem Ratio  |
|-----------|----------|--------------|---------------|---------|----------|------------|
| **100mb** |    7.81s |    **4.30s** |      **1.8x** |    5 GB |   280 MB |      0.06x |
| **10mb**  |  772.4ms |  **387.7ms** |      **2.0x** |  472 MB |    32 MB |      0.07x |
| **1mb**   |   82.3ms |   **39.5ms** |      **2.1x** |   48 MB |     8 MB |      0.16x |
| **100kb** |    9.9ms |    **6.4ms** |      **1.6x** |    6 MB |     5 MB |      0.84x |
| **10kb**  |    3.0ms |    **2.7ms** |      **1.1x** |    2 MB |     5 MB |      2.22x |
| **1kb**   |    2.9ms |    **2.5ms** |      **1.1x** |    2 MB |     5 MB |      2.22x |

## Pattern: strings

| Size      | jq       | succinctly   | Speedup       | jq Mem  | succ Mem | Mem Ratio  |
|-----------|----------|--------------|---------------|---------|----------|------------|
| **100mb** |    1.35s |  **579.6ms** |      **2.3x** |  130 MB |   112 MB |      0.86x |
| **10mb**  |  134.9ms |   **60.9ms** |      **2.2x** |   14 MB |    16 MB |      1.08x |
| **1mb**   |   15.4ms |    **8.3ms** |      **1.9x** |    3 MB |     6 MB |      2.00x |
| **100kb** |    3.7ms |    **2.9ms** |      **1.3x** |    2 MB |     5 MB |      2.33x |
| **10kb**  |    2.6ms |    **2.4ms** |      **1.1x** |    2 MB |     5 MB |      2.22x |
| **1kb**   |    2.6ms |    **2.5ms** |      **1.1x** |    2 MB |     5 MB |      2.22x |

## Pattern: unicode

| Size      | jq       | succinctly   | Speedup       | jq Mem  | succ Mem | Mem Ratio  |
|-----------|----------|--------------|---------------|---------|----------|------------|
| **100mb** |    1.67s |    **1.18s** |      **1.4x** |  297 MB |   128 MB |      0.43x |
| **10mb**  |  166.4ms |  **111.5ms** |      **1.5x** |   31 MB |    17 MB |      0.56x |
| **1mb**   |   19.1ms |   **13.0ms** |      **1.5x** |    5 MB |     6 MB |      1.15x |
| **100kb** |    4.2ms |    **3.3ms** |      **1.2x** |    2 MB |     5 MB |      2.33x |
| **10kb**  |    2.5ms |    **2.5ms** |      **1.0x** |    2 MB |     5 MB |      2.22x |
| **1kb**   |    2.5ms |    **2.4ms** |      **1.1x** |    2 MB |     5 MB |      2.22x |

## Pattern: users

| Size      | jq       | succinctly   | Speedup       | jq Mem  | succ Mem | Mem Ratio  |
|-----------|----------|--------------|---------------|---------|----------|------------|
| **100mb** |    2.03s |    **1.21s** |      **1.7x** |  663 MB |    91 MB |      0.14x |
| **10mb**  |  206.3ms |  **122.7ms** |      **1.7x** |   68 MB |    14 MB |      0.20x |
| **1mb**   |   22.4ms |   **14.0ms** |      **1.6x** |    8 MB |     6 MB |      0.70x |
| **100kb** |    4.3ms |    **3.5ms** |      **1.2x** |    2 MB |     5 MB |      2.33x |
| **10kb**  |    2.6ms |      2.8ms   |          0.9x |    2 MB |     5 MB |      2.22x |
| **1kb**   |    2.6ms |    **2.4ms** |      **1.1x** |    2 MB |     5 MB |      2.22x |
